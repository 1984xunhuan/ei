    ...
    <div id="contenter">
       <div id="intro">
		     ...
		     <ul style="list-style: none; display: block; margin: 0; padding: 0;">
		                    <?php if(count($this->data->product_list) > 0) {  ?> 
					       <?php foreach($this->data->product_list as $product) {  ?>
							<li style="line-height: 20px;">
							    <span style="float: left;">
								 <a href="index.php?ProductAction/web_product_show/item_id/<?php echo $this->data->item->item_id; ?>/product_id/<?php echo $product->product_id; ?>"><?php echo $product->product_name; ?></a>
							    </span>
							    <span style="float: right;"><?php echo $product->issue_time; ?></span><br/>
							</li>
							<?php } ?>
							<?php } ?>
						</ul>
						<ul style="list-style: none; display: block; margin: 0; padding: 0;">
							<li style="line-height: 20px;">
								...
								<a href="index.php?ProductAction/web_product_list/current_page/1/item_id/<?php echo $this->data->item->item_id; ?>">首页</a>
								<a href="index.php?ProductAction/web_product_list/current_page/<?php echo $this->data->page->current_page-1; ?>/item_id/<?php echo $this->data->item->item_id; ?>">上一页</a>
								<?php } ?>
								<?php if($this->data->page->current_page != $this->data->page->total_page) {  ?>
								<a href="index.php?ProductAction/web_product_list/current_page/<?php echo $this->data->page->current_page+1; ?>/item_id/<?php echo $this->data->item->item_id; ?>">下一页</a>
								<a href="index.php?ProductAction/web_product_list/current_page/<?php echo $this->data->page->total_page; ?>/item_id/<?php echo $this->data->item->item_id; ?>">尾页</a>
								<?php } ?>
							</li>	
						</ul>
	    </div>
